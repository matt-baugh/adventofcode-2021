...
def walk_to_9(coord: tuple[int, int], top_map: list[list[int]], leads_to_map: dict[tuple[int, int], int]) -> int:
...
def sum_scores(filename_str: str) -> int:
    ...
    for c in start_coords:
        scores += walk_to_9(c, top_map, leads_to_map)
...
if __name__ == "__main__":
    ...
    start = time()
    print('t1: ', task1.sum_scores("data1_real.txt"))
    print('t2: ', sum_scores("data1_real.txt"))
